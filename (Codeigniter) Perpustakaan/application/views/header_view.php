...
<head>
  ...
  <title><?php echo $title_web;?> | Perpus VSGA </title>
...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url('index.php/dashboard');?>" class="logo">
      ...
      <span class="logo-mini"><GA>VSGA</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Perpus VSGA</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          <li>
            ...
            <a href="<?= base_url('user/edit/'.$idbo);?>">
              Yokosoo, <i class="fa fa-edit"> </i> <?php echo $d->nama; echo ' | ( '.$d->level.' )'; ?></a>
          </li>
          <li>
            <a onclick="return confirm('Apa anda yakin ingin mengakhiri sesi ini?')" href="<?php echo base_url();?>login/logout">Keluar Sesi</a>
          </li>
