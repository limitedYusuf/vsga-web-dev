					...
					<div class="box box-primary">
						...
						<div class="box-body">
							...
							<form method="post" action="<?= base_url('data/katproses');?>">
								...
								<button type="submit" onclick="return confirm('Yakin ingin mengubah data ini?')" class="btn btn-primary"><i class="fa fa-edit"></i> Edit Kategori</button>
							</form>
							<?php }else{?>
							...
							<form method="post" action="<?= base_url('data/katproses');?>">
								...
								<button type="submit" onclick="return confirm('Yakin ingin menginput data ini?')" class="btn btn-primary"> <i class="fa fa-plus"></i> Tambah Kategori</button>
							</form>
							<?php }?>
						</div>
					</div>
