                    ...
                    <form action="<?php echo base_url('user/upd');?>" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label>E-mail</label>
                                    <input type="email"  value="<?= $user->email;?>" readonly class="form-control" name="email" required="required" placeholder="Contoh : email@gmail.com">
                                </div>
                                <div class="form-group">
                        ...
                        <div class="pull-right">
                            <button type="submit" onclick="return confirm('Yakin ingin mengubah data ini?')" class="btn btn-primary btn-md">Edit Data</button>
						</form>
						<?php if($this->session->userdata('level') == 'Petugas'){?>
