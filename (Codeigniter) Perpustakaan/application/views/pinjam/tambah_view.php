			    ...
			    <div class="box-body">
                    <form action="<?php echo base_url('transaksi/prosespinjam');?>" method="POST" enctype="multipart/form-data">
							...
							<div class="col-sm-5">
								<table class="table table-striped">
									...
									<tr>
										...
										<td>:</td>
										<td>
											<input type="number" min="1" required placeholder="Lama Pinjam Contoh : 2 Hari (2)" name="lama" class="form-control">
										</td>
									</tr>
								</table>
							</div>
                        ...
                        <div class="pull-right">
                            ...
                            <button type="submit" onclick="return confirm('Yakin ingin proses data ini?')" class="btn btn-primary btn-md">Submit</button>
                    </form>
		...
		<?php $no=1;foreach($buku->result_array() as $isi){?>
			<tr>
                ...
                <?php
                                        ...
                                        $px = (int)$isi['jml'] - (int)$dd->num_rows() ?? 0;
									?>
                    <?= $px;?>
                </td>
				<td><?= $isi['tgl_masuk'];?></td>
