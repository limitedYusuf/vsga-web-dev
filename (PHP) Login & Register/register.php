...
<head>
    ...
    <title>Register | Cerita Aja!</title>
    <!-- CSS -->
...
<div class="container">
    ...
    <div class="row px-3">
      <div class="col-lg-10 col-xl-9 card flex-row mx-auto px-0">
        <div class="img-kiri-r d-none d-md-flex"></div>
        <!-- Wrapper login -->
        <div class="card-body">
          <h4 class="title text-center mt-4">
            Daftar Akun untuk mengakses Portal
          </h4>
          <div class="form-box px-3">
            <div class="form-input">
              <span><i class="fa fa-user"></i></span>
              <input type="text" name="_nama" id="nama" placeholder="Nama Lengkap" tabindex="10">
            </div>
            <div class="form-input">
            ...
            <div class="form-input">
              ...
              <input type="username" name="_username" id="user" placeholder="Username" tabindex="10">
            </div>
            <div class="form-input">
            ...
            <div class="mb-3">
              <button type="submit" name="daftar" class="btn btn-block text-uppercase daftars">
                Register
              </button>
            </div>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('.daftars').click(function() {
            var user = $('#user').val();
            var pass = $('#pass').val();
            var nama = $('#nama').val();
            var gender = $('#gender').val();
        // validasi input kosong
            if(user.length == '' && pass.length == '' && nama.length == '' && gender.length == '') {
              Swal.fire({
              type: 'warning',
              title: 'Terciduk!',
              text: 'Semua inputan tidak boleh kosong :('
            });
            } else if(user.length == '') {
              Swal.fire({
              type: 'warning',
              ...
              text: 'Gender tidak boleh kosong :('
                ...
                } else if(response == 'terpakai') {
                    Swal.fire({
                    type: 'error',
                    title: 'Registrasi Gagal!',
                    text: 'Username yang kamu input sudah digunakan orang lain.'
                    });
                } else {
                    Swal.fire({
                    type: 'error',
                    title: 'Registrasi Gagal!',
                    text: 'Kesalahan Saat mendaftarkan akun.'
                    });
                }
